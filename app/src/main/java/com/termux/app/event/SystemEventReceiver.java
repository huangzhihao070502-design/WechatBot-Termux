...
public class SystemEventReceiver extends BroadcastReceiver {
    ...
    public synchronized void onActionBootCompleted(@NonNull Context context, @NonNull Intent intent) {
        ...
        // Start TermuxActivity to trigger bot script auto-run
        // The TermuxActivity's onServiceConnected() method will handle starting the bot script
        Intent activityIntent = new Intent(context, com.termux.app.TermuxActivity.class);
